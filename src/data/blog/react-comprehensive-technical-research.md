...
4. あるViewの更新が、別のModelの更新をトリガーする場合があった（例：未読スレッドの既読化処理など）。
5. 更新されたModelが再びViewを更新する。
...
2. **依存配列（Dependency Array）に嘘をつかない**:
