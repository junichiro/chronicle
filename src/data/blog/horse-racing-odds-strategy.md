...
```
合成オッズ = 1000 / 950 = 1.053倍
```

あるいは公式を使って、

```
合成オッズ = 1 / (1/2.0 + 1/4.0 + 1/5.0) = 1 / 0.95 = 1.053倍
```
...
```
新合成オッズ = 1 / (0.050841 - 0.000405 - 0.000716) = 1 / 0.049720 = 20.11倍
```
...
```
新合成オッズ = 1 / (0.050841 - 0.009804) = 1 / 0.041037 = 24.37倍
```
